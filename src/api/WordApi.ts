...
import type { ModifyWordType, RegisterWordType, SerchSelectType, WordPageRangeType, WordQuery } from "./types/WordType";
...
export const getRandomWordsApi = async (type: SerchSelectType): Promise<Word[]> => {
